...
<Field name="investorType">${current.tipe_investor}</Field>
<Field name="investorClientType">DIRECT</Field>
<Field name="accountLocalCode"></Field>
<Field name="accountClientCode"></Field>
<Field name="investorCompanyName"><![CDATA[${current.nama}]]></Field>
<Field name="investorCompanyBICCode"></Field>
<Field name="accountTaxCode"></Field>
<Field name="investorLegalDomicile">${current.domisili}</Field>
<Field name="investorNPWPNumber">${current.npwp}</Field>
...
<Field name="investorFundSource"></Field>
...
<Field name="investorAuthorizedPersonFirstName1"><![CDATA[${current.nama}]]></Field>
<Field name="investorAuthorizedPersonMiddleName1"><![CDATA[${current.nama_tengah}]]></Field>
<Field name="investorAuthorizedPersonLastName1"><![CDATA[${current.nama_belakang}]]></Field>
<Field name="investorAuthorizedPersonPosition1"><![CDATA[]]></Field>
<Field name="investorAuthorizedPersonKTPNumber1"></Field>
<Field name="investorAuthorizedPersonKTPExpiredDate1"></Field>
